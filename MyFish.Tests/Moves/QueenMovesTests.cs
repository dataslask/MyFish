...
namespace MyFish.Tests.Moves
{
    ...
    public class QueenMovesTests
    {
        ...
        {
            var expected = Expected.Moves("c1 c2 c4 c5 c6 c7 c8 a3 b3 d3 e3 f3 g3 h3 a1 b2 d4 e5 f6 g7 h8 a5 b4 d2 e1");
        ...
        {
            var expected = Expected.Moves("c2 c4 c5 c6 b3 d3 b2 d4 e5 f6 b4 d2");
        ...
        {
            var expected = Expected.Moves("c4 c5 b3 d3 b2 d4 e5 f6 a5 b4");
